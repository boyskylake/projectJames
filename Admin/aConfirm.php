      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">จัดการสมาชิก</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link">จัดการเจ้าหน้าที่</a>
            </li>
            <li class="nav-item">
              <a href="#" class="nav-link">จัดการรายการจอง</a>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <ul class="nav nav-pills flex-column">
            <li class="nav-item">
              <a href="#" class="active nav-link">ยืนยันสมาชิก</a>
            </li>
            <div class="row">
