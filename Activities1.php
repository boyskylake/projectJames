      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <li class="nav-item">
              <a class="nav-link" href="RPerson.php">สมัคสมาชิก</a>
            </li>
          </ul>
          </div>
        </div>
          ...
          <div class="col-md-4">
            <div class="col-md-12">
              <ul class="nav nav-pills flex-column">
                <li class="nav-item">
                  <a class="active nav-link" href="#">ข้อมูลทั่วไป</a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link">ประวัติความเป็นมา</a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link">ปรัชญา วิสัยทัศน์ พันธกิจ</a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link">บุคลากรประจำงานบริการสารสนเทศ</a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link">ติดต่อเรา</a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link">หน้าที่ความรับผิดชอบ</a>
                </li>
                <li class="nav-item">
                  <a href="#" class="nav-link">ระเบียบและมารยาทการใช้บริการห้องสมุด</a>
                </li>
                <ul class="nav nav-pills flex-column">
                  <li class="nav-item">
                    <a href="#" class="active nav-link">งานบริการสารสนเทศ</a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link">บริการยืม – คืนทรัพยากรสารสนเทศ</a>
                  </li>
                  <li class="nav-item">
                    <a href="#" class="nav-link">การสมัครสมาชิกห้องสมุด</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#">การต่ออายุบัตรสมาชิกห้องสมุด</a>
                  </li>
                  <ul class="nav nav-pills flex-column">
                    <li class="nav-item">
                      <a href="#" class="active nav-link">ล็อกอินเข้าใช้งาน</a>
                    </li>
                    <div class="row">
                      <div class="col-md-12">
                        <form class="">
                        ...
                        <div class="row">
                          <div class="col-md" align="right">
                            <div class="btn-group">
                              <button class="btn btn-primary dropdown-toggle" data-toggle="dropdown">สถานะ&nbsp;</button>
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="#">สมาชิก</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="#">บรรณารักษ์</a>
                              </div>
                              <a class="btn btn-primary" href="#">ตกลง</a>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <ul class="nav nav-pills flex-column">
                      <li class="nav-item">
                        <a class="active nav-link" href="#">เครือข่ายห้องสมุด</a>
                      </li>
                      <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a href="#" class="nav-link">ห้องสมุดประชาชน กศน. อำเภอวาริชภูมิ</a>
                      </li>
                      <li class="nav-item">
          ...
          <div class="col-md-8">
            <ul class="nav nav-pills flex-column">
              <ul class="nav nav-pills flex-column">
                <ul class="nav nav-pills flex-column">
                  <li class="nav-item">
                    <a href="#" class="active nav-link">กิจกรรม งานบริการสารสนเทศ</a>
                  </li>
                  <ul class="nav nav-pills flex-column">
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="#">รายละเดียด</a>
                    </li>
                    <ul class="nav nav-pills flex-column">
                      <li class="nav-item">
                        <a href="#" class="active nav-link">ภาพกิจกรรม</a>
                      </li>
                    </ul>
                    <div class="row">
                    ...
                    <div class="col-md" align="right">
                      <a href="#" class="btn btn-outline-primary">ยอนกลับ</a>
                      <a href="#" class="btn btn-outline-primary">เข้ารวม</a>
                    </div>
                  </ul>
                </ul>
              </ul>
