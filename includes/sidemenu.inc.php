        <ul class="nav nav-pills flex-column">
              ...
              <li class="nav-item">
                <a href="sidemenu/LibraryHistory.php" class="nav-link">ประวัติความเป็นมา</a>
              </li>
              <li class="nav-item">
                <a href="sidemenu/vision.php" class="nav-link">ปรัชญา วิสัยทัศน์ พันธกิจ</a>
              </li>
              <li class="nav-item">
                <a href="sidemenu/personnel.php" class="nav-link">บุคลากรประจำงานบริการสารสนเทศ</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="sidemenu/ContactUs.php">ติดต่อเรา</a>
              </li>
              <li class="nav-item">
                <a href="sidemenu/order.php" class="nav-link">ระเบียบและมารยาทการใช้บริการห้องสมุด</a>
              </li>
              <ul class="nav nav-pills flex-column">
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="sidemenu/Booking.php">บริการจอง – คืนทรัพยากรสารสนเทศ</a>
                </li>
                <li class="nav-item">
                  <a href="sidemenu/Subscription.php" class="nav-link">การสมัครสมาชิกห้องสมุด</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="sidemenu/CardRenewal.php">การต่ออายุบัตรสมาชิกห้องสมุด</a>
                </li>
                <ul class="nav nav-pills flex-column">
                  <li class="nav-item">
