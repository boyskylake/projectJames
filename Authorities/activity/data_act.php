...
?>                      <?php echo $numrow; ?>
              ...
              ?>
                                ...
                                $objQuery = mysqli_query($conn,$strSQL);
                                 ...
                                 ?>\'  width=\'150\'>')"><img src="images/photo.PNG" width="19" height="16" border="0" />
                                </td>
                                  <td><a href="photo_act.php?id_act=<?php echo $id_act?>" title="เพิ่มรูปภาพกิจกรรม">เพิ่มรูปภาพ<img src="images/attach.gif" width="8" height="13" border="0" /></a></td>
                                  <td><?php
                                    if($status_act=='1')
                                    {
                                    ...
                                    ?></td>
                                  <td><a href="data_act_edit.php?id_act=<?php echo $id_act?>" title="" ><img src="images/forward_f2.png" width="16" border="0" /></a></td>
                                  <td><a href="data_act_del.php?id_act=<?php echo $id_act?>" onclick="return confirm('คุณแน่ใจหรือไม่ที่จะลบข้อมูลกิจกรรมนี้  ++ ยืนยันการลบโดยเจ้าหน้าที่ ++ ')"><img src="images/publish_x.png" width="16" height="16" border="0" title="" /></a></td>
                                </tr>
                                <?php
                                $i++;
                                  }
